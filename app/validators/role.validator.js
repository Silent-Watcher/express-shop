...
function validateNewRoleData() {
	return [
		...
		body('permissions')
			...
			.withMessage('برای هر نقش حداقل یه اجازه دسترسی لازم است'),
	];
}

function validateEditRoleData() {
	return [
		body('name')
			.trim()
			.escape()
...
function validateDeleteRoleData() {
	return [];
}

module.exports = { validateNewRoleData, validateEditRoleData, validateDeleteRoleData };
